...
public class Constants {
	...
	public static final double NOMINAL_VOLTAGE = 0.3;
	public static final double TURN_P_LEFT = 0.020;
	public static final double TURN_P_RIGHT = 0.020;
	...
	public static final int ELEVATOR_FAST_DRIVING_MAX = -24000;
	public static final double CURRENT_LIMIT = 180;
	public static final double ELEVATOR_MAX_POSITION_DOUBLE = -48570;
	public static final double ELEVATOR_CURRENT_LIMIT = 45.0;
